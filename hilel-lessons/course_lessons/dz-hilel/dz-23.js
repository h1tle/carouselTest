...
let getLocalDate = (date, isSeconds = false, isISO = false) => {
	...
	if (!isISO) {
		const timeFormat = isSeconds ? `${hour}:${minutes}:${seconds}` : `${hour}:${minutes}`;
...
console.log(getLocalDate(myDate)); // Output: 11.02.2024, 08:30 AM
console.log(getLocalDate(myDate, true)); // Output: 11.02.2024, 08:30:45 AM
console.log(getLocalDate(myDate, false, true)); // Output: 2024-02-11, 08:30 AM
console.log(getLocalDate(myDate, true, true)); // Output: 2024-02-11, 08:30:45 AM
